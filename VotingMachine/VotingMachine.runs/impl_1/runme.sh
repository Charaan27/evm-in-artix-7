...
HD_PWD='D:/xilinxproj/VotingMachine/VotingMachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Voting_Machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Voting_Machine.tcl -notrace
