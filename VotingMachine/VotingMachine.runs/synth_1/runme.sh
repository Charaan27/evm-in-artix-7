...
HD_PWD='D:/xilinxproj/VotingMachine/VotingMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Voting_Machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Voting_Machine.tcl
